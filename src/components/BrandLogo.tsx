...
// Source asset: public/logo.svg (Oil & Gas Data House — orange + black drop).
//
...
//
// To rebrand the whole app, replace public/logo.svg (and adjust the dimensions
...
// Source SVG is 1240x340 (ratio 3.647). Widths below are computed from the
...
const DIMS: Record<Variant, { w: number; h: number; priority: boolean }> = {
  navbar:  { w: 132, h: 36, priority: true },
  auth:    { w: 234, h: 64, priority: true },
  sidebar: { w: 219, h: 60, priority: false },
};
