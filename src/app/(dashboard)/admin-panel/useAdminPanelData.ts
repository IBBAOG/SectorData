...
export const MODULE_LABELS: ModuleLabel[] = [
  ...
  { slug: "well-by-well",            label: "Well by Well",                 description: "Executive monthly oil & gas production summary (stake-weighted, 4 panels + YoY)" },
  { slug: "anp-cdp",                 label: "Production by Well",           description: "Monthly oil and gas production by well and field (ANP CDP)" },
