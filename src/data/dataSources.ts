...
export const DATA_SOURCES: DataSource[] = [
  ...
  },
  {
    ...
    description:
      "Weekly diesel and gasoline margin breakdown by component (base fuel, biofuel, federal tax, state tax, distribution and resale margin). Composed automatically each week from ANP, CEPEA/ESALQ, and CONFAZ inputs.",
    category: "proprietary",
    source: "Proprietary",
    sourceUrl: null,
    cronUtc: "0 15 * * 2",
    cronDescription: "Weekly on Tuesdays 15:00 UTC (automated composition via GitHub Actions)",
    sourceFrequency: "Weekly",
  ...
  {
    key: "cepea_etanol_anidro",
    name: "CEPEA/ESALQ — Anhydrous Ethanol (weekly)",
    description:
      "Weekly anhydrous ethanol price index published by CEPEA/ESALQ. Feeds the automated diesel & gasoline margin composition (gasoline biofuel component). CEPEA data is licensed CC BY-NC and must always be attributed.",
    category: "proprietary",
    source: "CEPEA/ESALQ",
    sourceUrl: "https://www.cepea.esalq.usp.br/br/indicador/etanol.aspx",
    cronUtc: "0 15 * * 2",
    cronDescription: "Weekly on Tuesdays 15:00 UTC (automated ingestion via GitHub Actions)",
    sourceFrequency: "Weekly",
    dashboards: [{ slug: "diesel-gasoline-margins", title: "Diesel and Gasoline Margins" }],
    supabaseTable: "cepea_etanol_anidro",
    isRealtime: false,
    staleAfterHours: 252,
    overdueAfterHours: 504,
  },
  {
    key: "anp_producao_derivados",
    name: "ANP — Refined Product Production (monthly)",
    description:
      "Monthly ANP refined-product (derivados) production volumes. Feeds the automated diesel & gasoline margin composition (base-fuel component).",
    category: "proprietary",
    source: "ANP",
    sourceUrl: "https://www.gov.br/anp/pt-br/centrais-de-conteudo/dados-abertos/producao-de-derivados-de-petroleo-e-processamento-de-gas-natural",
    cronUtc: "0 15 * * 2",
    cronDescription: "Weekly on Tuesdays 15:00 UTC (automated ingestion via GitHub Actions)",
    sourceFrequency: "Monthly",
    dashboards: [{ slug: "diesel-gasoline-margins", title: "Diesel and Gasoline Margins" }],
    supabaseTable: "anp_producao_derivados",
    isRealtime: false,
    staleAfterHours: 720,
    overdueAfterHours: 1440,
  },
