...
- **2026-05-28 (Rappi-style mobile /home redesign)** `[mobile-only]`: full visual overhaul of the `/home` mobile gallery inspired by the Rappi delivery app. The flat 2-col bento grid of `MobileHomeIconTile` rows was replaced by a three-tier composition of pastel "launcher" tiles:
