...
Dashboard Monthly Production (Oil & Gas). Owner: [`worker_dash-anp-cdp`](../../.claude/agents/worker_dash-anp-cdp.md). Source: ANP CDP (`anp_cdp_producao`).
...
Header dinâmico: "Monthly Production · {métrica} · {ano início}–{ano fim}".
