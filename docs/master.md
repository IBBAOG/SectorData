...
- 19 dashboards ativos (8 originais + 6 da Fase 3 remanescentes: `/anp-cdp`, `/anp-ppi`, `/anp-precos-produtores`, `/anp-glp`, `/mdic-comex`, `/anp-lpc` + 5 novos: `/imports-exports` (consolida `/anp-daie` + `/anp-desembaracos` + `/anp-painel-importacoes`, retirados em 2026-05-25), `/anp-precos-distribuicao`, `/anp-cdp-diaria`, `/anp-cdp-bsw`, `/anp-cdp-depletion`, `/subsidy-tracker` + `/admin-analytics` (Admin-only, sem `module_visibility`)).
